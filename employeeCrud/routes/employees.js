...
var connectionString =process.env.connect ;
...
exports.save = function (req, res) {
    ...
    var cols = [req.body.id,req.body.name, req.body.job, req.body.department, req.body.salary, req.body.hire_date];

    client.query('INSERT INTO employee(id,name, job, department, salary, hire_date) VALUES($1, $2, $3, $4, $5,$6) RETURNING *', cols, function (err, result) {
        if (err) {
